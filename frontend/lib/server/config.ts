...
export const FEED_CACHE_MS = parsePositiveInt(process.env.FEED_CACHE_MS, 5 * 1000)
...
export const HIGH_RISK_KM = Number(process.env.HIGH_RISK_KM ?? 10)
export const MED_RISK_KM = Number(process.env.MED_RISK_KM ?? 40)
